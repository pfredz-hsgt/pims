    ...
    const handleExportToPDF = () => {
        try {
            ...
            Object.entries(groupedItems).forEach(([source, items]) => {
                // Skip empty sources or unselected sources
                ...
                copies.forEach((copyLabel, copyIndex) => {
                    ...
                    autoTable(doc, {
                        ...
                        head: [[
                            ...
                            { content: 'Qt.', styles: { halign: 'center' } }, // Shortened header
                ...
                const timestamp = selectedDate.format('YYYY-MM-DD');
                doc.save(`Indent_Report_${source}_${timestamp}.pdf`);
                exportCount++;
            });
